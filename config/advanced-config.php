...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-ZJYBMSGNQD"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-ZJYBMSGNQD');
</script>
...
'version' => '2.1',
    ...
    */
    ...
    'custom_home_url' => 'https://start.bio6.me/', // Only applies if you set a "HOME_URL" in the config.
