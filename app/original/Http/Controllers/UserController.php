...
class UserController extends Controller
{
    ...
    public function littlelink(request $request)
    {
        ...
        $userinfo = User::select('id', 'name', 'littlelink_name', 'littlelink_description', 'littlelink_seotags','littlelink_ga4','littlelink_pixel', 'theme', 'role', 'block')->where('id', $id)->first();
    ...
    public function showPage(request $request)
    {
        ...
        $data['pages'] = User::where('id', $userId)->select('littlelink_name', 'littlelink_description','littlelink_seotags','littlelink_ga4','littlelink_pixel', 'image', 'name')->get();
    ...
    public function theme(request $request)
    {
        ...
        $userinfo = User::select('name', 'littlelink_name', 'littlelink_description','littlelink_seotags','littlelink_ga4','littlelink_pixel', 'theme')->where('id', $id)->first();
        $information = User::select('name', 'littlelink_name', 'littlelink_description','littlelink_seotags','littlelink_ga4','littlelink_pixel', 'theme')->where('id', $id)->get();
