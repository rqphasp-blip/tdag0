<div class="container">
	...
	<a style="text-decoration: none;" class="" href="https://bio6.me" target="_blank" title="Crie grátis seu Bio6.me">
		<div style="vertical-align: middle;display: inline-block;padding-bottom:50px;" class="credit-hover hvr-grow fadein">
			<img style="width:200px" class="" src="{{ asset('assets/linkstack/images/powered-by-linkstack.svg') }}" alt="Bio6.me">
		</div>
	</a>
	@endif
	</div>