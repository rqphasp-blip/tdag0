@extends("layouts.app") {{-- Ou o layout que você usa para as páginas de perfil/configurações --}}

{{-- Se o seu layout usa @yield("content") --}}
{{-- @section("content") --}}

{{-- Se o seu layout usa {{ $slot }} --}}
<x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __("Upload de Banner do Perfil") }}
    </h2>
</x-slot>
